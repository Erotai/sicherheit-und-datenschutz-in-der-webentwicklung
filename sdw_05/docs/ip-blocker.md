...
Wird ausschließlich mit dem Filter und der Hook `add_filter('init', ['\THM\Security\IPBlocker', 'init'], 5);` verwendet!

### 2. `check_ip_block(): bool {...}`

Beispiel:
````
**** Speichern der Rückgabe in einer Prüfvariable ****
$is_ip_blocked = check_ip_block();

**** Ausgabe der Prüfvariable ****
